...
pub fn range_update_point_query(
    _arr: &[Tracked<i32>],
    _ops: &[(bool, usize, usize, i32)],
) -> Vec<i32> {
    todo!()
...
pub fn merge_sort_tree(_arr: &[Tracked<i32>], _queries: &[(usize, usize, i32)]) -> Vec<i32> {
    todo!()
}

/// Lazy propagation: range update (add delta) + range sum query.
/// ops: (true, l, r, delta) for update; (false, l, r, 0) for query.
pub fn lazy_propagation(_arr: &[Tracked<i32>], _ops: &[(bool, usize, usize, i32)]) -> Vec<i32> {
    todo!()
}

/// Persistent segment tree: kth smallest (0-indexed) in arr[l..=r].
pub fn persistent_kth_smallest(
    _arr: &[Tracked<i32>],
    _queries: &[(usize, usize, usize)],
) -> Vec<i32> {
    todo!()
}

/// Maximum number of non-overlapping intervals.
pub fn max_non_overlapping_intervals(_intervals: &[(Tracked<i32>, Tracked<i32>)]) -> i32 {
    todo!()
}
...
pub fn max_subarray_in_range(_arr: &[Tracked<i32>], _queries: &[(usize, usize)]) -> Vec<i32> {
    todo!()
}
...
pub fn dynamic_segment_tree(
    _updates: &[(Tracked<i32>, Tracked<i32>)],
