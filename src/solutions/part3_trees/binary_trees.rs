...
pub fn max_depth(_tree: &[Tracked<Option<i32>>]) -> i32 {
    todo!()
}
...
pub fn invert_tree(_tree: &[Tracked<Option<i32>>]) -> Vec<Option<i32>> {
    todo!()
}

/// Level Order Traversal: return values grouped by level, left to right.
/// Example: [3,9,20,None,None,15,7] -> [[3],[9,20],[15,7]]
pub fn level_order(_tree: &[Tracked<Option<i32>>]) -> Vec<Vec<i32>> {
    todo!()
}
...
pub fn zigzag_level_order(_tree: &[Tracked<Option<i32>>]) -> Vec<Vec<i32>> {
    todo!()
}

/// Right Side View: return the values visible from the right side, top to bottom.
/// Example: [1,2,3,None,5,None,4] -> [1,3,4]
pub fn right_side_view(_tree: &[Tracked<Option<i32>>]) -> Vec<i32> {
    todo!()
}
...
pub fn flatten_to_linked_list(_tree: &[Tracked<Option<i32>>]) -> Vec<i32> {
    todo!()
}
...
pub fn construct_from_preorder_inorder(
    _preorder: &[Tracked<i32>],
    _inorder: &[Tracked<i32>],
) -> Vec<Option<i32>> {
    todo!()
}
...
pub fn max_path_sum(_tree: &[Tracked<Option<i32>>]) -> i32 {
    todo!()
}
...
pub fn serialize_deserialize(_tree: &[Tracked<Option<i32>>]) -> Vec<Option<i32>> {
    todo!()
}
...
pub fn lowest_common_ancestor(_tree: &[Tracked<Option<i32>>], _p: i32, _q: i32) -> i32 {
    todo!()
}

/// Diameter: return the diameter of the tree (longest path in edges between any two nodes).
/// Example: [1,2,3,4,5] -> 3
pub fn diameter(_tree: &[Tracked<Option<i32>>]) -> i32 {
    todo!()
}
...
pub fn count_complete_tree_nodes(_tree: &[Tracked<Option<i32>>]) -> i32 {
    todo!()
}
