...
pub fn bst_search(_tree: &[Option<i32>], _target: i32) -> bool {
    todo!()
}
...
pub fn bst_minimum(_tree: &[Option<i32>]) -> i32 {
    todo!()
}
...
pub fn bst_sorted_array_to_bst(_nums: &[i32]) -> Vec<Option<i32>> {
    todo!()
}
...
pub fn bst_insert(_tree: &[Option<i32>], _val: i32) -> Vec<Option<i32>> {
    todo!()
}
...
pub fn bst_delete(_tree: &[Option<i32>], _val: i32) -> Vec<Option<i32>> {
    todo!()
}

/// BST Kth Smallest: return the kth smallest element (1-indexed).
/// Example: tree=[3,1,4,None,2], k=1 -> 1
pub fn bst_kth_smallest(_tree: &[Option<i32>], _k: usize) -> i32 {
    todo!()
}
...
pub fn bst_inorder_successor(_tree: &[Option<i32>], _val: i32) -> Option<i32> {
    todo!()
}
...
pub fn bst_lca(_tree: &[Option<i32>], _p: i32, _q: i32) -> i32 {
    todo!()
}
...
pub fn bst_recover(_tree: &[Option<i32>]) -> Vec<Option<i32>> {
    todo!()
}

/// BST Count Nodes in Range: count how many nodes have values in [lo, hi].
/// Example: tree=[10,5,15,3,7,13,18], lo=6, hi=13 -> 4
pub fn bst_count_nodes_in_range(_tree: &[Option<i32>], _lo: i32, _hi: i32) -> i32 {
    todo!()
}
...
pub fn bst_from_preorder(_preorder: &[i32]) -> Vec<Option<i32>> {
    todo!()
}
...
pub fn bst_iterator(_tree: &[Option<i32>]) -> Vec<i32> {
    todo!()
}
...
pub fn bst_merge_two(_tree1: &[Option<i32>], _tree2: &[Option<i32>]) -> Vec<i32> {
    todo!()
}
