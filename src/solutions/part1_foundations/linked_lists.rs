...
pub fn reverse_list(_vals: &[Tracked<i32>]) -> Vec<i32> {
    todo!()
}
...
pub fn merge_two_sorted(_l1: &[Tracked<i32>], _l2: &[Tracked<i32>]) -> Vec<i32> {
    todo!()
}
...
pub fn has_cycle(_vals: &[Tracked<i32>], _cycle_pos: Option<usize>) -> bool {
    todo!()
}

/// Remove Nth From End: remove the nth node from the end of a list.
/// n is 1-indexed (n=1 means remove the last node).
pub fn remove_nth_from_end(_vals: &[Tracked<i32>], _n: usize) -> Vec<i32> {
    todo!()
}

/// Is Palindrome: check if a linked list is a palindrome.
pub fn is_palindrome(_vals: &[Tracked<i32>]) -> bool {
    todo!()
}
...
pub fn add_two_numbers(_l1: &[Tracked<i32>], _l2: &[Tracked<i32>]) -> Vec<i32> {
    todo!()
}

/// Reorder List: reorder L0->L1->...->Ln to L0->Ln->L1->Ln-1->L2->Ln-2->...
pub fn reorder_list(_vals: &[Tracked<i32>]) -> Vec<i32> {
    todo!()
}

/// Sort List: sort a linked list in O(n log n) time.
pub fn sort_list(_vals: &[Tracked<i32>]) -> Vec<i32> {
    todo!()
}
...
pub fn remove_duplicates_ii(_vals: &[Tracked<i32>]) -> Vec<i32> {
    todo!()
}

/// Rotate List: rotate the list to the right by k places.
/// Example: [1,2,3,4,5] rotated by 2 -> [4,5,1,2,3]
pub fn rotate_list(_vals: &[Tracked<i32>], _k: usize) -> Vec<i32> {
    todo!()
}
...
pub fn reverse_k_group(_vals: &[Tracked<i32>], _k: usize) -> Vec<i32> {
    todo!()
}
...
pub fn copy_random_pointer(_vals: &[Tracked<i32>]) -> Vec<i32> {
    todo!()
}
...
pub fn flatten_multilevel(_vals: &[Tracked<i32>]) -> Vec<i32> {
    todo!()
}
