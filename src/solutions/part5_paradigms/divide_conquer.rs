...
pub fn skyline(_buildings: &[(i32, i32, i32)]) -> Vec<(i32, i32)> {
    todo!()
}
...
pub fn kth_smallest_sorted_matrix(_matrix: &[Vec<i32>], _k: usize) -> i32 {
    todo!()
}
