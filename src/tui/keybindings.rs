...
pub fn render_help(f: &mut Frame, screen: &Screen) {
    ...
    let bindings = match screen {
        ...
        Screen::ProblemDetail { .. } => vec![
            ...
            ("v", "Watch algorithm visualization"),
        ...
        Screen::ReplayPlayer { .. } => vec![
            ...
            ("", ""),
            ("", "── Color Legend ──"),
            ("\u{2588} Yellow", "Comparing"),
            ("\u{2588} Red", "Swapping / Target"),
            ("\u{2588} Green", "Sorted / Done"),
            ("\u{2588} Cyan", "Active pointer"),
            ("\u{2588} Lt.Cyan", "Reading"),
            ("\u{2588} Magenta", "Writing"),
            ("\u{2588} Lt.Magenta", "Pivot"),
            ("\u{2588} Lt.Green", "Found"),
        ],
